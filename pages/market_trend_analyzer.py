...
import sys # Add sys
import os # Add os
sys.path.append(os.path.abspath(os.path.join(os.path.dirname(__file__), '..'))) # Add path for root modules
from nlp_parser import parse_query
from data_fetcher import get_stock_data
import pandas as pd

def main():
    st.set_page_config(layout="wide", title="📈 Market Trend Analyzer") # Can set title here
